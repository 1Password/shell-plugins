...
func APIKey() schema.CredentialType {
	return schema.CredentialType{
		...
		DocsURL:       sdk.URL("https://render.com/docs/api_key"), // TODO: Replace with actual URL
		ManagementURL: sdk.URL("https://console.render.com/user/security/tokens"), // TODO: Replace with actual URL
...
var defaultEnvVarMapping = map[string]sdk.FieldName{
	"RENDER_API_KEY": fieldname.APIKey, // TODO: Check if this is correct
}
