...
// CacheOperations modify the state of the encrypted cache.
// Puts are data that will be written to cache.
// Removes are data that will be deleted from cache.
// All Removes are deleted before any Puts are written.
